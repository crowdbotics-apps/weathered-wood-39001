"""
Django settings for weathered_wood_39001 project.
...
ROOT_URLCONF = 'weathered_wood_39001.urls'
...
WSGI_APPLICATION = 'weathered_wood_39001.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_wood_39001 API",
    "DESCRIPTION": "API documentation for weathered_wood_39001 App",
    "VERSION": "v1",
}
